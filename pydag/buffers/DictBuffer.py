...
class DictBuffer(Buffer):
    ...
    timestamps_key  : str = field(default="timestamps", metadata={"description": "Key under which timestamps are stored."})
    timestamps_format : str = field(default="unix", metadata={"description": "Format: 'unix' (milliseconds integer) or 'iso' (ISO 8601 strings)."})
