...
class Contour:
    ...
    show : bool = True
    color : str = ColorNames.BLACK.value
...
class Trace:   
    ...
    def set_surfacecolor(self, surfacecolor : object):
    ...
    def wireframe(self, color : str = ColorNames.BLACK.value):
        dic = {}
        dic["x"] = Contour(show = True, color = color)
        dic["y"] = Contour(show = True, color = color)
        dic["z"] = Contour(show = True, color = color)
        self.contours = dic
...
class Layout:
    ...
    def set_autosize(self, autosize : bool = True):
...
class Plotly:
    ...
    def add_trace(self, name: str, trace: Trace):
        """
