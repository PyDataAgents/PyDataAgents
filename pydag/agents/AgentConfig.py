...
class AgentConfig:
    ...
    def __init__(self, grabber : Agent = None):
    ...
    def create(self) -> Agent:
        ...
        if len(self.grabber_config) > 0:
            grabber : Agent = ClassUtils.create_instance(self.grabber_config["type"])            
            ...
            raise AgentException("Grabber configuration is not set.")
