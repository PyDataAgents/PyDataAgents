...
|-------|------|---------|-------------|
| `id` | `str` | `<dataclasses._MISSING_TYPE object at 0x000002823E3C1100>` | unique identifier of element in DataAgent application |
...
obj = Adapter()
obj.id=<dataclasses._MISSING_TYPE object at 0x000002823E3C1100>
