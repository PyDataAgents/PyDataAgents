...
def test_000():
    ...
    ISO = IsomapDimReduction(dimensions=dimensions, sample_length=10, min_learning_samples=10, min_inference_samples=1, persistent=False)
    ISO.install()
    ...
    for i in range(50):
        ...
        ISO.execute()
        data = ISO.buffer.data(n=10, persistent=False)
...
def test_001():
    ...
    ISO = IsomapDimReduction(dimensions=dimensions, sample_length=10, features_from_parent=["values"], min_learning_samples=10, min_inference_samples=1, persistent=False)
    ISO.install()
